...
namespace LiveSplit.ALinkToThePast.UI.Components
{
    ...
    class LocationWatcher : Dictionary<string, Func<LocationState>>
    {
        ...
        public LocationWatcher()
        {
            ...
            AddLocation("Arrghus", LocationState.INACCESSIBLE, () => CheckBoss(Dungeon.SWAMPPALACE));
            ...
            AddLocation("Blind", LocationState.INACCESSIBLE, () => CheckBoss(Dungeon.THIEVESTOWN));
            ...
            AddLocation("Catfish", LocationState.INACCESSIBLE, () => CheckFlag("Special Items", SpecialItems.CATFISH), () => CheckAccess(DarkWorldRegion.NORTHEAST));
            ...
            AddLocation("Desert Cliff", LocationState.INACCESSIBLE, () => CheckOverworldArea(48), () => CheckFlag("Book of Mudora") || (CheckAccess(DarkWorldRegion.SOUTHWEST) && CheckMirror()));
            ...
            AddLocation("Flute Boy", LocationState.INACCESSIBLE, () => CheckFlag("Special Items", SpecialItems.FLUTEBOY), () => CheckAccess(DarkWorldRegion.SOUTH, true));
            ...
            AddLocation("Hammer Cave", LocationState.INACCESSIBLE, () => CheckRoom(295, 7, false), () => CheckAccess(DarkWorldRegion.NORTHWEST, true) && CheckFlag("Hammer") && CheckLevel("Gloves", GlovesLevel.TITAN));
            ...
            AddLocation("Hookshot Cave", LocationState.INACCESSIBLE, 60, 4, () => CheckAccess(DeathMountainRegion.DARKEAST) && CheckFlag("Moon Pearl") && CheckFlag("Hookshot"), () => CheckAccess(DeathMountainRegion.DARKEAST) && CheckFlag("Moon Pearl") && CheckFlag("Boots") && !CheckRoom(60, 4, false));
            ...
            AddLocation("Ice Palace", LocationState.INACCESSIBLE, () => CheckDungeon(DungeonItem.ICEPALACE, () => CheckBoss(Dungeon.ICEPALACE), () => CheckRoom(31), () => CheckRoom(46), () => CheckRoom(63), () => CheckRoom(95), () => CheckRoom(126), () => CheckRoom(158), () => CheckRoom(174)), () => CheckLevel("Gloves", GlovesLevel.TITAN) && CheckFlag("Fire Rod") && CheckFlag("Flippers"), glitchAccessible: () => CheckLevel("Gloves", GlovesLevel.TITAN) && CheckFlag("Fire Rod"));
            AddLocation("Kakariko Well", LocationState.PARTIAL, 47, 5, () => CheckBombs());
            AddLocation("Kholdstare", LocationState.INACCESSIBLE, () => CheckBoss(Dungeon.ICEPALACE));
            ...
            AddLocation("Lanmolas", LocationState.INACCESSIBLE, () => CheckBoss(Dungeon.DESERTPALACE), () => (CheckFlag("Book of Mudora") || (CheckAccess(DarkWorldRegion.SOUTHWEST) && CheckMirror())) && CheckLevel("Gloves", GlovesLevel.POWER) && (CheckFlag("Lantern") || CheckFlag("Fire Rod")));
            ...
            AddLocation("Skull Woods", LocationState.INACCESSIBLE, () => CheckDungeon(DungeonItem.SKULLWOODS, () => CheckRoom(87), () => CheckRoom(87, 2, false), () => CheckRoom(88), () => CheckRoom(88, 2, false), () => CheckRoom(89), () => CheckRoom(103), () => CheckRoom(104)), () => CheckAccess(DarkWorldRegion.NORTHWEST) && CheckFlag("Fire Rod"), () => CheckAccess(DarkWorldRegion.NORTHWEST));
            ...
            AddLocation("Swamp Palace", LocationState.INACCESSIBLE, () => CheckDungeon(DungeonItem.SWAMPPALACE, () =>CheckBoss(Dungeon.SWAMPPALACE), () => CheckRoom(52), () => CheckRoom(53), () => CheckRoom(54), ()=> CheckRoom(55), () => CheckRoom(70), () => CheckRoom(102), () => CheckRoom(118), () => CheckRoom(118, 2, false)), () => CheckAccess(DarkWorldRegion.SOUTH) && CheckMirror() && CheckFlag("Flippers"));
            ...
            AddLocation("Thieves' Town", LocationState.INACCESSIBLE, () => CheckDungeon(DungeonItem.THIEVESTOWN, () => CheckBoss(Dungeon.THIEVESTOWN), () => CheckRoom(68), () => CheckRoom(69), () => CheckRoom(101), () => CheckRoom(203), () => CheckRoom(219), () => CheckRoom(219, 2, false), () => CheckRoom(220)), () => CheckAccess(DarkWorldRegion.NORTHWEST, true) && CheckFlag("Hammer"), () => CheckAccess(DarkWorldRegion.NORTHWEST, true));
            ...
            AddLocation("Trinexx", LocationState.INACCESSIBLE, () => CheckBoss(Dungeon.TURTLEROCK));
            AddLocation("Turtle Rock", LocationState.INACCESSIBLE, () => CheckDungeon(DungeonItem.TURTLEROCK, () => CheckBoss(Dungeon.TURTLEROCK), () => CheckRoom(4), () => CheckRoom(20), () => CheckRoom(36), () => CheckRoom(182), () => CheckRoom(183), () => CheckRoom(183, 2, false), () => CheckRoom(213), () => CheckRoom(213, 2, false), () => CheckRoom(213, 3, false), () => CheckRoom(213, 4, false), () => CheckRoom(214)), visible: () => CheckAccess(DeathMountainRegion.DARKEAST));
            AddLocation("Vitreous", LocationState.INACCESSIBLE, () => CheckBoss(Dungeon.MISERYMIRE));
